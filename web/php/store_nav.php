  ...
  <nav>
    <div class="nav-wrapper green lighten-1">
      ...
      <ul class="right">
        <li <?php if ($page=="cart") { echo "class=\"active\""; } ?> ><a href="cart.php"><i class="material-icons">shopping_cart</i></a></li>
      </ul>
      <ul class="right hide-on-med-and-down">
          <li><a href="assign.php"><i class="material-icons left">play_for_work</i>Assignments</a></li>
          <li <?php if ($page=="store") { echo "class=\"active\""; } ?> ><a href="store.php"><i class="material-icons left">store</i>Browse Store</a></li>
      </ul>
